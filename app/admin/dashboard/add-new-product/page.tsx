...
import { z } from "zod";
import { Plus, X, Upload, Tag, Layers, Layout, Check, Image as ImageIcon } from "lucide-react";
                ...
                {imageFields.map((field, index) => (
                  ...
                  >
                    {getValues(`images.${index}.url`) ? (
                            ...
                            >
                              {({ open }) => (
                                <button
                                  type="button"
                                  onClick={() => open()}
                                  className="p-2 bg-white rounded-full hover:bg-indigo-100 transition-all"
                                >
                      ...
                      <div className="w-full aspect-square flex items-center justify-center border border-dashed border-gray-300 rounded-md bg-gray-50">
                        <CldUploadWidget
                          onSuccess={(info) => handleImageUpload(index, info)}
                          uploadPreset="UrbanThreadz"
                          options={{
                        ...
                        >
                          {({ open }) => (
                            <button
                              type="button"
                              onClick={() => open()}
                              className="flex flex-col items-center space-y-2 text-gray-500 hover:text-indigo-600 transition-all"
                            >
                              <Upload size={24} />
